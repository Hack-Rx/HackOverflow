...
class EditFood extends React.Component {
  ...
  work : Update the food values depending on new servingSize or numberOfServing data.
  */
  ...
  /*
    name getFood,
    work : Get users extended food info from FoodCentral API.
 */
  getFood = async () => {
    await submitForm(
      undefined,
  ...
  /*
    name getFoodToEdit,
    work : Get users food that needs to be edited. Updates all corresponding state.
 */
  getFoodToEdit = async () => {
  ...
  /*
    ...
    work : update number of servings state and update state that should be effected by this update.
 */
  ...
  /*
     ...
     work : update serving size amount state and update state that should be effected by this update.
  */
