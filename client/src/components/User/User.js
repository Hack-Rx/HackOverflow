    ...
    return(
      <main id="settings">
        ...
        <form onSubmit={async (e) => await submitForm(
          ...
          <input onChange={ (e) => this.setState({goalWeight: e.target.value}) } name="goalWeight" required step="0.1" min="10" max="700" id="goalWeight" type="number" placeholder={this.state.goalWeight} />
          <br />
